...
def test_ensure_dummy_fixture_files_creates_files():
	with tempfile.TemporaryDirectory() as tmpdir:
		...
		with (
			patch('murphy.io.fixtures.FIXTURES_DIR', fixtures_dir),
			patch('murphy.io.fixtures.DUMMY_FILE_PATH', fixtures_dir / 'dummy.txt'),
			patch('murphy.io.fixtures.DUMMY_CSV_PATH', fixtures_dir / 'dummy.csv'),
			patch('murphy.io.fixtures.DUMMY_PDF_PATH', fixtures_dir / 'dummy.pdf'),
			patch('murphy.io.fixtures.DUMMY_EXE_PATH', fixtures_dir / 'dummy.exe'),
			patch('murphy.io.fixtures.DUMMY_DOCX_PATH', fixtures_dir / 'dummy.docx'),
		):
